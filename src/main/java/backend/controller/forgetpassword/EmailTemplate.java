...
public class EmailTemplate {
    ...
    public String getTalentAcc() {
        return "<!DOCTYPE html>\n" +
                ...
                "<body>\n" +
                "\t<div class=\"email-container\">\n" +
                "\t\t<p>Selamat anda telah bergabung !!</p>\n" +
                "\t\t<p>Anda dapat aktivasi akun dengan menekan link di bawah ini </p>" +
                "\t\t\n" +
                "\t\t<a href=\"{{VERIF_LINK}}\">{{VERIF_LINK}}</A>" +
                "\t\t\n" +
                "\t\t<p>Anda dapat melalkukan login dengan email dan password :</p>" +
                "\t\t\n" +
                "\t\temail: <b>{{EMAIL_USER}}</b>" +
                "\t\tpassword: <b>{{PASS_USER}}</b>\n" +
                "\t\t\n" +
                "\t\t<p class=\"mt--15\">Jika kamu butuh bantuan atau pertanyaan, hubungi customer care kami di .... atau kirim email ke ....</p>\n" +
                "\t\t\n" +
                "\t\t<p>Semoga harimu menyenangkan!</p>\n" +
